...
export const MochissantLogo = ({ color = 'currentColor', className, ...props }: LogoProps) => 
  createElement('svg', {
...
export const MochissantCircleLogo = ({ color = 'currentColor', className, ...props }: LogoProps) =>
  createElement('svg', {
...
export const EgMochissantLogo = ({ color = 'currentColor', className, ...props }: LogoProps) =>
  createElement('svg', {
