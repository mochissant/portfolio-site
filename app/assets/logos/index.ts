...
export const MochissantLogo: React.FC<LogoProps> = ({ color = 'currentColor', className, ...props }) => (
  <svg viewBox="0 0 1060.14 227.99" className={className} {...props}>
    <path
      fill={color}
...
export const MochissantCircleLogo: React.FC<LogoProps> = ({ color = 'currentColor', className, ...props }) => (
  <svg viewBox="0 0 470.13 468" className={className} {...props}>
    <path
      fill="none"
      stroke={color}
      strokeMiterlimit="10"
...
export const EgMochissantLogo: React.FC<LogoProps> = ({ color = 'currentColor', className, ...props }) => (
  <svg viewBox="0 0 350.65 60.16" className={className} {...props}>
    <path
      fill={color}
